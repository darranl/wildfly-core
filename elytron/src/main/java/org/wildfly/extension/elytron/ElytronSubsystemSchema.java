...
public enum ElytronSubsystemSchema implements PersistentSubsystemSchema<ElytronSubsystemSchema> {
    ...
    VERSION_19_0(19),
    VERSION_19_0_PREVIEW(19, Stability.PREVIEW), // WildFly 42.0-onwards
    ;
    static final Map<Stability, ElytronSubsystemSchema> CURRENT = Feature.map(EnumSet.of(VERSION_19_0, VERSION_19_0_PREVIEW));
